    ...
    <>
      ...
      <div className="container mt-5">
        <div className="row row-cols-2 row-cols-md-4 g-5">
          <div className="col">
            <img src="/tok.jpg" alt="" className="img-fluid rounded-mine" />
            <h5 className="text-center fw-bb bb2 mt-2">Tokyo</h5>
          </div>
          <div className="col">
            <img src="/kyo.jpg" alt="" className="img-fluid rounded-mine" />
            <h5 className="text-center fw-bb bb2 mt-2">Kyoto</h5>
          </div>
          <div className="col">
            <img src="/osa.jpg" alt="" className="img-fluid rounded-mine" />
            <h5 className="text-center fw-bb bb2 mt-2">Osaka</h5>
          </div>
          <div className="col">
            <img src="/yok.jpg" alt="" className="img-fluid rounded-mine" />
            <h5 className="text-center fw-bb bb2 mt-2">Yokohama</h5>
          </div>
        </div>
      </div>
      ...
      <div>
        <img src="/japan.jpg" alt="" className="img-fluid fw-img" />
      </div>
